...
**NightMonopoly** — это атмосферная версия классической игры "Монополия", выполненная в стильном ночном антураже. Игроку предстоит кидать кубик, продвигаться по игровому полю и собирая различные бонусы на своем пути. Визуальная часть игры включает детализированные 3D-модели, качественные анимации и проработанную работу со светом, что делает игровой процесс особенно захватывающим.
...
**DOTween** использовался для анимации объектов и создания плавных переходов, что добавило больше динамики и визуальной плавности в игре.

## Скриншоты игры

<p align="center"> 
      <img src='https://github.com/PiRaMiDeON/NightMonopoly/blob/main/Imgs/Screenshot1.jpg' width=880>
</p>
<p align="center"> 
      <img src='https://github.com/PiRaMiDeON/NightMonopoly/blob/main/Imgs/Screenshot2.jpg' width=880> 
</p>
<p align="center"> 
      <img src='https://github.com/PiRaMiDeON/NightMonopoly/blob/main/Imgs/Screenshot3.jpg' width=880>
</p>
...
- [**DOTween**](http://dotween.demigiant.com/) - мощный инструмент для анимации и создания плавных переходов в Unity.
...
- Использование **DOTween** для анимации игровых объектов.
